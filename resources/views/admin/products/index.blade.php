...
<div class="header header-filter" style="background-color: deepskyblue;" ></div>
...
<div class="row">
   ...
   <div class="section text-center" >
    ...
    <div class="team" >
        <div class="row">
            <a style="background-color:green;" href="{{url('admin/products/create')}}" class="btn btn-primary btn-round">Nuevo producto</a>
